# 
# Project automation script for toplevel 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source toplevel.tcl), then you can
...
set myProject "toplevel"
set myScript "toplevel.tcl"
...
proc add_source_files {} {
   ...
   xfile add "$zestSC1root/UCF/ZestSC1.ucf"
   xfile add "$zestSC1root/Verilog/ZestSC1_Host.v"
   xfile add "$zestSC1root/Verilog/ZestSC1_Interfaces.v"
   xfile add "$zestSC1root/Verilog/ZestSC1_SRAM.v"
   xfile add "toplevel.v"
   xfile add "nmigen.v"
...
proc set_process_props {} {
   ...
   project set "Report Fastest Path(s) in Each Constraint" "false" -process "Generate Post-Place & Route Static Timing"
   ...
   project set "Load Setting File" "Default" -process "Analyze Power Distribution (XPower Analyzer)"
   project set "Load Setting File" "Default" -process "Generate Text Power Report"
   project set "Setting Output File" "Default" -process "Generate Text Power Report"
   ...
   project set "Report Type" "Error Report" -process "Generate Post-Place & Route Static Timing"
   ...
   project set "Work Directory" "/home/ttsiod/Xilinx/KB/ZestSC1/Examples/toplevel/FPGA-Verilog/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "toplevel" -process "Generate IBIS Model"
